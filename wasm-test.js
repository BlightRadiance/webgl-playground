...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_22fe1366e1644d846c92928bda49c2691e1e3c9d": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){gameObjects [($1)]= new THREE.Mesh (geometry , material);})());
            },
            ...
            "__extjs_753e57cc133eac2ccbb0416747df23721407fc61": function($0, $1, $2, $3) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);$3 = Module.STDWEB.to_js($3);Module.STDWEB.from_js($0, (function(){var cube = gameObjects [($1)]; cube.rotation.x += ($2); cube.rotation.y += ($3); renderer.render (scene , camera);})());
            },
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.wasm_test.exports = Module.exports;
        }
    ...
    if( Module.nodejs ) {
        ...
        const wasm_path = path.join( __dirname, "wasm-test.wasm" );
        ...
        const __promise = fetch( "wasm-test.wasm" )
